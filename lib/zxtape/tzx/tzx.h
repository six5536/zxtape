...
#define PSTR(x)           TZX_PSTR(x)

#define HIGH              TZX_HIGH
#define LOW               TZX_LOW
#define INPUT             TZX_INPUT
#define OUTPUT            TZX_OUTPUT
#define O_RDONLY          TZX_O_RDONLY

#define outputPin         TZX_outputPin

#define bitRead(value, bit)     TZX_bitRead(value, bit)
#define bitSet(value, bit)      TZX_bitSet(value, bit)
#define bitClear(value, bit)    TZX_bitClear(value, bit)
#define bitToggle(value, bit)   TZX_bitToggle(value, bit)
#define bitWrite(value, bit)    TZX_bitWrite(value, bit)

#define word(x0, x1)            TZX_word(x0, x1)
#define long(x)                 TZX_long(x)
#define highByte(x)             TZX_highByte(x)
#define lowByte(x)              TZX_lowByte(x)
#define pgm_read_byte(x)        TZX_pgm_read_byte(x)


#define strlen(str)             TZX_strlen(str)
#define strlwr(str)             TZX_strlwr(str)
#define strstr_P(x, y)          TZX_strstr(x, y)
...
#define ReadUEFHeader           TZX_ReadUEFHeader
#define writeUEFData            TZX_writeUEFData
...
#define dir                     TZX_dir
#define filesize                TZX_filesize
#define Timer                   TZX_Timer
#define pauseOn                 TZX_pauseOn
